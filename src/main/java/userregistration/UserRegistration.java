...
public class UserRegistration {
    public static void main(String[] args)
    {
        ...
        if (matches)
            ...
            Pattern pattern_password11 = Pattern.compile("^[_A-Za-z0-9-\\\\+]+(\\\\.[_A-Za-z0-9-]+)*@\" + \"[A-Za-z0-9-]+(\\\\.[A-Za-z0-9]+)*(\\\\.[A-Za-z]{2,})$");
            Matcher matcher_password11 = pattern_password11.matcher(password11);
            boolean matches_password11 = matcher_password11.find();
            if (matches_password11)
                System.out.println("Valid password");
            else
                System.out.println("InValid password");
